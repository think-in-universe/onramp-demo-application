...
import { nearClient } from "../utils/intents/constants/nearClient";
import { logger } from "../utils/intents/logger";
import { decodeQueryResult } from "../utils/intents/near";

export const RESERVED_NEAR_BALANCE = BigInt("100000000000000000000000"); // 0.1 NEAR reserved for transaction fees and storage
